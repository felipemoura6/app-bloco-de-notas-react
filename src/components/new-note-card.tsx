...
export function NewNoteCard ({ onNoteCreated }: NewNoteCardPropos) {
    ...
    function handleStartRecording( ) {
        ...
        const isSpeechReconitionAPIAvailable = 'SpeechRecognition' in window
    ...
    return (
        ...
        <Dialog.Root>
            <Dialog.Trigger className="flex flex-col rounded-md bg-slate-700 text-left p-5 outline-none gap-3 hover:ring-2 hover:ring-slate-600 focus-visible: ring-2 focus-visible:ring-lime-400">
